...
//   TouchableOpacity,
// } from "react-native";
// import { baseUrlImage, getFollowData } from "../../constants/endpoints";
// import axios from "axios";
// import { useSelector } from "react-redux";
// import { useNavigation } from "@react-navigation/native";
...
//   const fetchData = async () => {
//     try {
//       const response = await axios.get(`${getFollowData}/${user?._id}`);
//       if (response.data.data && response.data.success) {
//         const followedUserIds = response.data.data.followings.map(
//           (following) => following.toUser._id // Modify this based on your backend response structure
//         );
...
//       <TouchableOpacity
//         onPress={() =>
//           navigation.navigate("userFollowScreen", { userId: item })
//         }
//       >
//         <Image
//           source={
